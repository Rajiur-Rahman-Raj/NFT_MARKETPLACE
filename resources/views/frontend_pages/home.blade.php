                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body p-6">
                                    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                                        ...
                                        <div class="dark:border-jacarta-600 border-jacarta-100 relative mb-2 flex items-center overflow-hidden rounded-lg border">
                                            <input id="login__password" type="password" name="password" data-id="{{ $latest->id }}" class="login__password{{ $latest->id }} focus:ring-accent h-12 w-full flex-[3] border-0 focus:ring-inset" placeholder="Password" />
                                        </div>
...
@section('js')
  <script>
    $(document).ready(function(){
        ...
        $("#login__password").keypress(function (e) {
        ...
        $('.loginFromBannerModal').on('click', function (){
            ...
            $.ajax({
                ...
                error: function(){
                    $('#errorPassBanner').html('<p style="color:#fa3232;font-weight:bold">Please provide valid informaition</p>');
                },
            });
        });
